...
*/
                         ...
                         NomerOwner = '919389379221' //Ganti Pake Nomer Lu.
                         FakeNya = '©sakura bot  2022' //Ganti Sesuai Keininan Nama Fake Lu.
...
const fakethumb = (teks, yes) => {
    ...
    teks = `
👋(♥ω♥*) konnichiwa ${pushname}
 i am sakura ready to help you 😍
•  my Instagram : www.instagram.com/kakashi_0.3 
 🔮command list🔮
 
  [  🧧ᴅᴏᴡɴʟᴏᴀᴅ  menu🧧     ] 
❣️${prefix}igstory [Nama Ig Nya]
❣️${prefix}play [Query]
❣️${prefix}ytmp4 [Link]
❣️${prefix}ytmp3 [Link]
...
loll = fs.readFileSync("./stik/thumb.jpeg") 
               oyai = `*┌──「 ʀᴜʟᴇs ʙᴏᴛ 」*
*│┌──*
*││°* 1. *ɪғ ʏᴏᴜ sᴘᴀᴍ ʙᴏᴛ ᴅᴍ*
*││° ᴇᴀsʏ ʙʟᴏᴄᴋ 🤣
*││──*
*││°* 2. * ᴄᴀʟʟɪɴɢ ʙᴏᴛ*
*││° ᴇᴀsʏ ʙʟᴏᴄᴋ🤣
*││──*
*││°* 3. 🦄🧧ᴍᴇssᴀɢᴇ ᴏᴡɴᴇʀ ᴛᴏ ᴀᴅᴅ ᴍᴇ 
*││° 
*││──*
*││°* 4. ʀᴇsᴘᴇᴄᴛ ᴏᴡɴᴇʀ 
*││──*
*││°* 5. ɪғ ᴜ ᴡᴀɴɴᴀ ᴊᴏɪɴ ʙᴏᴛ ɢʀᴜᴘ ᴛʜᴇɴ    ᴀsᴋ ᴏᴡɴᴇʀ 
*││°  𝟼. ᴊᴏɪɴ ʙᴏᴛ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 
      🧧 ᴢᴇʀᴏ ᴛᴡᴏ sᴜᴘᴘᴏʀᴛ 🧧
*││ https://chat.whatsapp.com/CPQJoQEPRCN3rOacY9TLYP
       ғᴏʀ ʜᴇɴᴛᴀɪ ᴜsᴇʀs 
       ʜᴛᴛᴘs://ᴄʜᴀᴛ.ᴡʜᴀᴛsᴀᴘᴘ.ᴄᴏᴍ/ᴋᴄ𝟺𝟹ᴀ𝟺ᴜʏᴛᴊᴢ𝟶𝟶xᴇ𝟶ᴡxᴠᴢ𝟽ᴠ
*││°* *ᴏᴡɴᴇʀ ʙᴏᴛ↓↓*
*││°* wa.me/${NomerOwner}
*│└──*
*└──「 🧧🦄sakura🧧🦄 」*`                  
...
_bot downloading media and files it may take some time_`
